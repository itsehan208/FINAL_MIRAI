...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    const fs = require("fs");
    return api.sendMessage("", event.threadID, () => api.sendMessage({body:`🥰 আসসালামু আলাইকুম গ্রুপবাসী 😇\n✢━━━━━━━━━━━━━━━━━━━✢\nBOT SUCCESSFULLY CONNECTED TO THE GROUP - ✅\n✢━━━━━━━━━━━━━━━━━━━✢\nBOT PREFIX - [ ${global.config.PREFIX} ]\nসকল কমান্ড দেখতে Help কমান্ড টাইপ করুন 😉\n${global.config.PREFIX}help - See All Commands\nএডমিনকে রিপোর্ট করতে কল্ড কমান্ড ব্যবহার করুন 🫡\n${global.config.PREFIX}called - [ Message ]\n✢━━━━━━━━━━━━━━━━━━━✢\nযেকোনো অভিযোগ অথবা হেল্প এর জন্য ফেসবুকে নক করতে পারেন 🤥
FB Link : https://www.facebook.com/gamingboy242`, attachment: fs.createReadStream(__dirname + "/cache/joinGif/bot_add.gif")} ,threadID));
  }
  else {
    try {
