module.exports.config = {
    ...
    description: "আপনি কাকে চুদতে চান এমন 1 জনকে @mention করতে হবে",
...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("আপনি কাকে চুদতে চান এমন 1 জনকে @mention করতে হবে", event.threadID);
...
a("𝐀𝐒𝐈𝐅 𝐱𝟔𝟗 বট এর চুদা লো🤟");

setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুদি তোর বাবা আমি 🥰।" + " " + name, mentions: arraytag})}, 3000);

setTimeout(() => {a({body: "খাংকির পোলা তর কচি বোন রে চুদি তোর বাবা আমি 😍.." + " " + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a({body: "depression থেকেও তর মাইরে চু*** দি তোর বাবা আমি🤬 " + " " + name, mentions: arraytag})}, 15000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি তোর বাবা আমি  তর বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "Hi আমার জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Welcome শুয়োরের বাচ্চা তোর বাবা আমি 🥰।" + " " + name, mentions: arraytag})}, 174000);
...
setTimeout(() => {a({body: "Hi আমার জারজ ছেলে, মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("~আমার জারজ ছেলে। জা ভাগ🤖")} , 39000);
