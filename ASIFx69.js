...
console.log(chalk.bold.hex("#03f0fc").bold("[ ASIF ] » ") + chalk.bold.hex("#fcba03").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`𝐀𝐒𝐈𝐅 𝐱𝟔𝟗`, '[ 𝐀𝐒𝐈𝐅 𝐱𝟔𝟗 ]');
        logger('Hey, thank you for using this Bot', '[ 𝐀𝐒𝐈𝐅 𝐱𝟔𝟗 ]');
        logger("Fixed by 𝐀𝐒𝐈𝐅 𝐱𝟔𝟗", '[ 𝐀𝐒𝐈𝐅 𝐱𝟔𝟗 ]');
        logger("FB: https://facebook.com/4S1F.403", 'Fixed by 𝐀𝐒𝐈𝐅 𝐱𝟔𝟗');
      var cron = require("node-cron");
